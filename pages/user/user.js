...
Page({
  ...
  onLoad: function () {
    ...
    if (userInfo.avatarUrl==''){
      userInfo.avatarUrl = '/static/images/user-photo.gif'
    }
  ...
  requestData: function (){//获取优惠券值 积分值
    ...
    wx.request({//优惠券值
      url: textUrl+'user/getUserCouponNum?uuid=' + uuid,
      method: "get",
      header: {
    ...
    // wx.request({//积分值
    //   url: 'https://minisuperuat.shinshop.com/web/user/getUserPoint?uuid=' + uuid,
    //   method: "get",
    //   header: {
    //     "Content-Type": "application/text"
    //   },
